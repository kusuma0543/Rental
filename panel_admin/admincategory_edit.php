                        ...
                        <div class="panel-heading">
                         ...
                         <div class="panel-body" >
                          <div class="col-md-12">
                            ...
                            <?php
                                                    $sql="SELECT * FROM admincategory WHERE id='$sno'";
                                                    $result=mysqli_query($con,$sql);
                                                    $row=mysqli_fetch_array($result);
                                                ?>
                                                <div class="form-group"><label class="col-sm-2 control-label text-right">Category Title  </label>
                                                  <div class="col-sm-10"><input type="text" name="main_category" class="form-control android"  value="<?php echo $row['cname']?>"></div>
                                                </div>
                              <div class="form-group" style="margin-left: 20%">
                            <label>File input</label>
                             <input type="file" name="s_files">
                               <br><br><center><img src='<?php echo $row['cimgurl']?>' width='150'></center>
                           </div>
...
$ggfm=mysqli_real_escape_string($con,$_POST['main_category']);


$requ="http://24x7shoppers.com/kusuma0543/rental/panel_admin/admin_images/";


// $snl="select * from admincategory";
...
if(($_FILES["s_files"]["size"])!=0)
   {
    ...
    $img1=$requ.$_FILES["s_files"]["name"];
         ...
         $query="UPDATE admincategory set cname='$ggfm',cimgurl='$img1' where id='$sno'";
...
}   else
   {
     ...
     $query="UPDATE admincategory set cname='$ggfm',cimgurl='$img1' where id='$sno'";
         $ans = mysqli_query($con,$query) or die("Can't insert :".mysql_error());
                     ...
                     header("location:admincategory_edit.php?yes=1");
                       ob_end_flush();
                       exit;
                   }
