                    ...
                    <div class="col-md-12">
                      <div class="panel form-element-padding">
                        <div class="panel-heading">
                         <h4>Insert Category Details</h4>
                        </div>

                         <div class="panel-body" >
                          <div class="col-md-12">
<form action=# method='post' enctype="multipart/form-data">
                            <div class="form-group"><label class="col-sm-2 control-label text-right" placeholder="Category">Category Title</label>
                              <div class="col-sm-10"><input type="text" name="title" class="form-control android"></div>
                            </div>
<br><br>

                              <div class="form-group" style="margin-left: 20%">
                            <label>File input</label>
                             <input name="f_input" type="file">
                           </div>
                            <br>
...
if(($_FILES["f_input"]["size"])!=0)
                        {
                         move_uploaded_file($_FILES["f_input"]["tmp_name"],"admin_images/". $_FILES["f_input"]["name"]);
                         $img1=$requ.$_FILES["f_input"]["name"];
...
$mmk="INSERT INTO admincategory (cid,cname,cimgurl) values ('$c_id','$utitle','$img1')";
$hhby=mysqli_query($con,$mmk);

                     header("location:admincategories_insert.php?yes=1");
                       ob_end_flush();
                       exit;
                   }
