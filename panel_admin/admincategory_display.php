          ...
          <!-- end: Left Menu -->
            ...
            <div id="content">
                  ...
                  <div class="panel-body">
                    <div class="col-md-12">
                        ...
                        <p class="animated fadeInDown">
                          Table <span class="fa-angle-right fa"></span> Category
                        </p>
                    </div>
                  </div>
              </div>
              ...
              <div class="col-md-16 top-20 padding-0">
                <div class="col-md-12">
                  <div class="panel">
                    <div class="panel-heading"><h3>Category Details</h3></div>
                    <div class="panel-body">
                                  ...
                                  $result=mysqli_query($con,$sql);
                                    ...
                                    while($row=mysqli_fetch_array($result))
                                                    ...
                                                    <td><?php echo $row['cid'];?></td>
                                                       ...
                                                       <td><?php echo $row['cimgurl'];?></td>



  <td><button type="submit" name="submit" class="btn btn-primary">
<a  href="admincategory_edit.php?id=<?php echo $sn;?>">
    Edit..</a></button><br><br>
  <button type="submit" name="submit" class="btn btn-primary">
<a  href="admincategory_delete.php?id=<?php echo $sn;?>">
    Delete</a></button>
  </td>
                                                         </tr>
